...
Основной репозиторий проекта — `BAITC-Hacks/hack-654d40a5-lexus`, выданный организатором. Отправка кода в GitHub и действие «Сдать решение» на платформе хакатона выполняются отдельно. Срок финальной отправки, уточнённый командой, — **17:50**; код и документация должны быть отправлены до этого времени. В исходном Положении указан срок 18:00, но для сдачи используем более ранний срок. Публичное размещение приложения не настроено; для проверки используется локальный адрес **http://localhost:8080**.
